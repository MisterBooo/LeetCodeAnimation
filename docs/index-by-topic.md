...
| 103 | 二叉树的锯齿形层序遍历 | 中等 | 二叉树 | [binary-tree-zigzag-level-order-traversal](https://www.algomooc.com/leetcode-animation/binary-tree-zigzag-level-order-traversal) |
...
| 70 | 爬楼梯 | 简单 | 动态规划 | [climbing-stairs](https://www.algomooc.com/leetcode-animation/climbing-stairs) |
...
| 118 | 杨辉三角 | 简单 | 动态规划 | [pascals-triangle](https://www.algomooc.com/leetcode-animation/pascals-triangle) |
...
| 19 | 删除倒数第 N 个结点 | 中等 | 链表 · 快慢指针 | [remove-nth-node-from-end-of-list](https://www.algomooc.com/leetcode-animation/remove-nth-node-from-end-of-list) |
| 21 | 合并两个有序链表 | 简单 | 链表 · 双指针 | [merge-two-sorted-lists](https://www.algomooc.com/leetcode-animation/merge-two-sorted-lists) |
...
| 141 | 环形链表 | 简单 | 链表 · 快慢指针 | [linked-list-cycle](https://www.algomooc.com/leetcode-animation/linked-list-cycle) |
| 142 | 环形链表 II | 中等 | 链表 | [linked-list-cycle-ii](https://www.algomooc.com/leetcode-animation/linked-list-cycle-ii) |
| 148 | 排序链表 | 中等 | 链表 · 归并排序 | [sort-list](https://www.algomooc.com/leetcode-animation/sort-list) |
| 160 | 相交链表 | 简单 | 链表 · 双指针 | [intersection-of-two-linked-lists](https://www.algomooc.com/leetcode-animation/intersection-of-two-linked-lists) |
| 203 | 移除链表元素 | 简单 | 链表 | [remove-linked-list-elements](https://www.algomooc.com/leetcode-animation/remove-linked-list-elements) |
| 206 | 反转链表 | 简单 | 链表 · 双指针 | [reverse-linked-list](https://www.algomooc.com/leetcode-animation/reverse-linked-list) |
| 234 | 回文链表 | 简单 | 链表 · 综合 | [palindrome-linked-list](https://www.algomooc.com/leetcode-animation/palindrome-linked-list) |
| 328 | 奇偶链表 | 中等 | 链表 | [odd-even-linked-list](https://www.algomooc.com/leetcode-animation/odd-even-linked-list) |
| 445 | 两数相加 II | 中等 | 链表 | [add-two-numbers-ii](https://www.algomooc.com/leetcode-animation/add-two-numbers-ii) |
...
| 22 | 括号生成 | 中等 | 回溯 · 括号 | [generate-parentheses](https://www.algomooc.com/leetcode-animation/generate-parentheses) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 4 | 寻找两个正序数组的中位数 | 困难 | 二分查找 | [median-of-two-sorted-arrays](https://www.algomooc.com/leetcode-animation/median-of-two-sorted-arrays) |
...
| 35 | 搜索插入位置 | 简单 | 二分查找 | [search-insert-position](https://www.algomooc.com/leetcode-animation/search-insert-position) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 1 | 两数之和 | 简单 | 数组 · 哈希表 | [two-sum](https://www.algomooc.com/leetcode-animation/two-sum) |
| 26 | 删除有序数组中的重复项 | 简单 | 数组 · 快慢指针 | [remove-duplicates-from-sorted-array](https://www.algomooc.com/leetcode-animation/remove-duplicates-from-sorted-array) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 20 | 有效的括号 | 简单 | 栈 | [valid-parentheses](https://www.algomooc.com/leetcode-animation/valid-parentheses) |
...
| 150 | 逆波兰表达式求值 | 中等 | 栈 | [evaluate-reverse-polish-notation](https://www.algomooc.com/leetcode-animation/evaluate-reverse-polish-notation) |
...
| 394 | 字符串解码 | 中等 | 栈 | [decode-string](https://www.algomooc.com/leetcode-animation/decode-string) |
| 946 | 验证栈序列 | 中等 | 栈 | [validate-stack-sequences](https://www.algomooc.com/leetcode-animation/validate-stack-sequences) |
...
| 21 | 合并两个有序链表 | 简单 | 链表 · 双指针 | [merge-two-sorted-lists](https://www.algomooc.com/leetcode-animation/merge-two-sorted-lists) |
| 88 | 合并两个有序数组 | 简单 | 双指针 | [merge-sorted-array](https://www.algomooc.com/leetcode-animation/merge-sorted-array) |
| 125 | 验证回文串 | 简单 | 双指针 | [valid-palindrome](https://www.algomooc.com/leetcode-animation/valid-palindrome) |
| 160 | 相交链表 | 简单 | 链表 · 双指针 | [intersection-of-two-linked-lists](https://www.algomooc.com/leetcode-animation/intersection-of-two-linked-lists) |
| 206 | 反转链表 | 简单 | 链表 · 双指针 | [reverse-linked-list](https://www.algomooc.com/leetcode-animation/reverse-linked-list) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 3 | 无重复字符的最长子串 | 中等 | 滑动窗口 | [longest-substring-without-repeating-characters](https://www.algomooc.com/leetcode-animation/longest-substring-without-repeating-characters) |
| 76 | 最小覆盖子串 | 困难 | 滑动窗口 · 变长 | [minimum-window-substring](https://www.algomooc.com/leetcode-animation/minimum-window-substring) |
| 209 | 长度最小的子数组 | 中等 | 滑动窗口 | [minimum-size-subarray-sum](https://www.algomooc.com/leetcode-animation/minimum-size-subarray-sum) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 42 | 接雨水 | 困难 | 单调栈 | [trapping-rain-water](https://www.algomooc.com/leetcode-animation/trapping-rain-water) |
| 84 | 柱状图中最大的矩形 | 困难 | 单调栈 | [largest-rectangle-in-histogram](https://www.algomooc.com/leetcode-animation/largest-rectangle-in-histogram) |
...
| 219 | 存在重复元素 II | 简单 | 哈希表 | [contains-duplicate-ii](https://www.algomooc.com/leetcode-animation/contains-duplicate-ii) |
| 349 | 两个数组的交集 | 简单 | 哈希表 | [intersection-of-two-arrays](https://www.algomooc.com/leetcode-animation/intersection-of-two-arrays) |
...
| 26 | 删除有序数组中的重复项 | 简单 | 数组 · 快慢指针 | [remove-duplicates-from-sorted-array](https://www.algomooc.com/leetcode-animation/remove-duplicates-from-sorted-array) |
| 141 | 环形链表 | 简单 | 链表 · 快慢指针 | [linked-list-cycle](https://www.algomooc.com/leetcode-animation/linked-list-cycle) |
| 283 | 移动零 | 简单 | 快慢指针 | [move-zeroes](https://www.algomooc.com/leetcode-animation/move-zeroes) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 9 | 回文数 | 简单 | 数学 | [palindrome-number](https://www.algomooc.com/leetcode-animation/palindrome-number) |
...
| 530 | 二叉搜索树的最小绝对差 | 简单 | 二叉搜索树 | [minimum-absolute-difference-in-bst](https://www.algomooc.com/leetcode-animation/minimum-absolute-difference-in-bst) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 146 | LRU 缓存 | 中等 | 设计 | [lru-cache](https://www.algomooc.com/leetcode-animation/lru-cache) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 242 | 有效的字母异位词 | 简单 | 哈希计数 | [valid-anagram](https://www.algomooc.com/leetcode-animation/valid-anagram) |
...
| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 120 | 三角形最小路径和 | 中等 | DP | [triangle](https://www.algomooc.com/leetcode-animation/triangle) |

## DP 入门（1）

| # | 题目 | 难度 | 分类 | 网站路径 |
| :-- | :-- | :-- | :-- | :-- |
| 1137 | 泰波那契数 | 简单 | DP 入门 | [n-th-tribonacci-number](https://www.algomooc.com/leetcode-animation/n-th-tribonacci-number) |
